...
import { Box, Grid, Typography, Button, useMediaQuery, useTheme, IconButton, Modal, CircularProgress, Divider } from '@mui/material';
...
import { OrderTemplateType } from '@/types/order'; // Adjust the import path
    ...
    return (
        <div>
            ...
            <Box sx={{ position: 'relative', padding: '16px' }}>
                {
                    savedTemplate ? <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                        <Typography
                            variant="h6"
                            sx={{
                                padding: '5px 10px',
                            ...
                            >
                                ...
                                <Box sx={{ position: 'relative' }}>
                                    ...
                                    <IconButton
                                        ...
                                        onClick={() => handleEnlargeTemplate(template)}
                                    >
                                        <ZoomInIcon />
                                    </IconButton>
                                </Box>
